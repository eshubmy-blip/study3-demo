...
import './App.css'
import { supabasePing } from "./utils/supabasePing";
...
function App() {
  ...
  // 初始化：生成用户ID
  useEffect(() => {
    console.error('[ENV CHECK] VITE_SUPABASE_URL =', import.meta.env.VITE_SUPABASE_URL)
    console.error(
      '[ENV CHECK] VITE_SUPABASE_ANON_KEY =',
      import.meta.env.VITE_SUPABASE_ANON_KEY?.slice(0, 12),
      '...'
    )
    supabasePing(); // 新增：测试 Supabase 连接/权限
